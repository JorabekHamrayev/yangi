...
define('API_KEY','1183132285:AAHzDbA3LRm8oC5tBzUlQfl2Ts_JXnKTBh0'); 
...
$url = $telegram['message']['text'];
 ...
 if($url == "/start"){
  ...
  'sendMessage', [
   'chat_id'=> $user_id,
   'text'=> 'Salom xush kelibsiz. Iltimos linkni kerakli faylga yuboring',
  ]);  
 }else{
   
  if(filter_var($url, FILTER_VALIDATE_URL)){
   bot('sendMessage', ['chat_id'=> $user_id,'text'=> 'Faylni yuklanmoqda📥 ...']);
